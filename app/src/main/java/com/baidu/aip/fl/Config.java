...
public class Config {
    ...
    public static String apiKey = "RoBFiEorwZKRFBcEazUXt7rj";
    public static String secretKey = "cHlID8qxP1IG7BGSnMod8u6h2H3eVhad";
    public static String licenseID = "wyxc-face-android";
    ...
    public static String groupID ="MyGroup";
